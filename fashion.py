...
s = 42
c = 3   #1 /2/3
root = '/notebooks/L_DMI/L_DMI/MNIST'
batch_size = 128
if c == 1: # class-independent noise
    conf_matrix = [[1 - r/2,r/2], [r/2, 1-r/2]]
if c == 2: # class-dependent noise (a)
    conf_matrix = [[1-r,r], [0, 1]]
if c == 3: # class-dependent noise (b)
...
class fashion(data.Dataset):
    ...
    def __init__(self, root, train, valid, test, transform=None, target_transform=None, download=True):
        self.root=root
